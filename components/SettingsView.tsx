      ...
      <div className="grid gap-6">
        ...
        <div className={`${theme === 'dark' ? 'bg-[#1E1E1E] border-white/5' : 'bg-white border-slate-100'} rounded-2xl p-8 shadow-xl border transition-colors duration-500`}>
          <div className="flex items-center justify-between mb-6">
            ...
            {dndActive && (
              <div className={`px-4 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest transition-colors duration-500 ${isNowDnd() ? 'bg-[#B5A47A] text-[#1A1A1A]' : 'bg-[#B5A47A]/10 text-[#B5A47A] border border-[#B5A47A]/20'}`}>
          ...
          <div className="divide-y divide-slate-100 dark:divide-white/5">
            <Toggle 
              ...
              sublabel="in der eingestellten Zeit Lautlos"
              active={dndActive} 
        ...
        <div className="p-10 text-center">
           <p className="text-[10px] opacity-30 font-bold uppercase tracking-[0.2em]">GuG Verein Management System v1.0.6</p>
        </div>
      </div>
    </div>
  );
